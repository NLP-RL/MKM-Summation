...
def val_epoch(model,
    ...
    with torch.no_grad():
        for step, batch in enumerate(tqdm(data_loader, desc="Validation Loss Iteration")):
            ...
            input_ids, attention_mask, visual_input, labels, intent_labels = batch
...
def train(model,
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        print("\nval_rouge_1: {}\tval_rouge_2: {}\tval_rouge_L: {}\tval_bleu_1: {}\tval_bleu_2: {}\tval_bleu_3: {}\tval_bleu_4: {}\tval_meteor: {}\tval_BS: {}\tval_J: {}".format(
        val_results['rouge_1'], val_results['rouge_2'], val_results['rouge_L'], val_results['bleu_1'], val_results['bleu_2'], val_results['bleu_3'], val_results['bleu_4'], val_results['meteor'],val_results['jaccard_score'],val_results['Bert Score']))
       
        print("\ntest_rouge_1: {}\ttest_rouge_2: {}\ttest_rouge_L: {}\ttest_bleu_1: {}\ttest_bleu_2: {}\ttest_bleu_3: {}\ttest_bleu_4: {}\ttest_meteor: {}\tval_BS: {}\tval_J: {}".format(
        test_results['rouge_1'], test_results['rouge_2'], test_results['rouge_L'], test_results['bleu_1'], test_results['bleu_2'], test_results['bleu_3'], test_results['bleu_4'], test_results['meteor'],val_results['jaccard_score'],val_results['Bert Score']))
       
        #if epoch == MAX_EPOCHS - 1:
        path = "MTMDS/Ablation_1"
...
test_data.to_csv("MTMDS/Ablation_1/test_data.csv")
